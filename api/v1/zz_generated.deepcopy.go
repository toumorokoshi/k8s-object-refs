...
func (in *GenericObjectRef) DeepCopyInto(out *GenericObjectRef) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GenericObjectRef.
func (in *GenericObjectRef) DeepCopy() *GenericObjectRef {
	if in == nil {
		return nil
	}
	out := new(GenericObjectRef)
	in.DeepCopyInto(out)
	return out
}
